...
class RenderDataPushups extends StatefulWidget {
  ...
  @override
  _RenderDataPushupsState createState() => _RenderDataPushupsState();
}

class _RenderDataPushupsState extends State<RenderDataPushups> {
  Map<String, List<double>> inputArr;

  String excercise = 'pushups';
  double upperRange = 500;
  double lowerRange = 700;
