...
class PushedPageV extends StatefulWidget {
  final List<CameraDescription> cameras;
  final String title;
  const PushedPageV({this.cameras, this.title});
  @override
  _PushedPageVState createState() => _PushedPageVState();
}

class _PushedPageVState extends State<PushedPageV> {
  List<dynamic> _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
  int x = 1;
