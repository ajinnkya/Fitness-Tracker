...
class PushedPageW extends StatefulWidget {
  final List<CameraDescription> cameras;
  final String title;
  const PushedPageW({this.cameras, this.title});
  @override
  _PushedPageWState createState() => _PushedPageWState();
}

class _PushedPageWState extends State<PushedPageW> {
  List<dynamic> _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
  int x = 1;
