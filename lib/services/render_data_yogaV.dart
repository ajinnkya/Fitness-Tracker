...
class RenderDataYogaV extends StatefulWidget {
  ...
  @override
  _RenderDataYogaVState createState() => _RenderDataYogaVState();
}

class _RenderDataYogaVState extends State<RenderDataYogaV> {
  Map<String, List<double>> inputArr;

  String excercise = 'Vrikshsan';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Vrikshasan position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (leftAnkleY > 350 && leftAnkleY <600 && rightAnkleY > 600 ) {
      ankleAlignment = true;
      setState(() {
    ...
    if (wristAlignment && ankleAlignment) {
      setState(() {
        ...
        memo = 'Vrikshsan position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Vrikshsan position not aligned.';
      });
    }
  }
