...
class PushedPagePD extends StatefulWidget {
  final List<CameraDescription> cameras;
  final String title;
  const PushedPagePD({this.cameras, this.title});
  @override
  _PushedPagePDState createState() => _PushedPagePDState();
}

class _PushedPagePDState extends State<PushedPagePD> {
  List<dynamic> _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
  int x = 1;
