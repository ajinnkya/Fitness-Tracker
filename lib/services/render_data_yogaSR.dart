...
class RenderDataYogaSR extends StatefulWidget {
  ...
  @override
  _RenderDataYogaSRState createState() => _RenderDataYogaSRState();
}

class _RenderDataYogaSRState extends State<RenderDataYogaSR> {
  Map<String, List<double>> inputArr;

  String excercise = 'Sarvangasan';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Sarvangasan position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    setState(() {
      ...
      rightHipY = poses['leftHip'][1];
    });

    if (leftShoulderY>600&&
        rightShoulderY>600) {
      wristAlignment = true;
      setState(() {
    ...
    if (leftAnkleX <300 && leftAnkleX > 200 && rightAnkleX < 255   && rightAnkleX < 150 && leftAnkleY<300 &&  rightAnkleY<300) {
      ankleAlignment = true;
      setState(() {
    ...
    if (wristAlignment && ankleAlignment) {
      setState(() {
        ...
        memo = 'Sarvangasan position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Sarvangasan position not aligned';
      });
    }
  }
