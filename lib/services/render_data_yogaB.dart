...
class RenderDataYogaB extends StatefulWidget {
  ...
  @override
  _RenderDataYogaBState createState() => _RenderDataYogaBState();
}

class _RenderDataYogaBState extends State<RenderDataYogaB> {
  Map<String, List<double>> inputArr;

  String excercise = 'Bhujangasan';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Bhujangasan position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (wristAlignment && ankleAlignment) {
      setState(() {
        ...
        memo = 'Bhujangasan position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Bhujangasan position not aligned.';
      });
    }
  }
