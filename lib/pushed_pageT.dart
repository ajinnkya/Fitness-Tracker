...
class PushedPageT extends StatefulWidget {
  final List<CameraDescription> cameras;
  final String title;
  const PushedPageT({this.cameras, this.title});
  @override
  _PushedPageTState createState() => _PushedPageTState();
}

class _PushedPageTState extends State<PushedPageT> {
  List<dynamic> _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
  int x = 1;
