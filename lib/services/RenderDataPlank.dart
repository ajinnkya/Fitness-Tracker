...
class RenderDataPlank extends StatefulWidget {
  ...
  @override
  _RenderDataPlankState createState() => _RenderDataPlankState();
}

class _RenderDataPlankState extends State<RenderDataPlank> {
  Map<String, List<double>> inputArr;

  String excercise = 'Plank';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Plank position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (leftAnkleX < 700 && rightAnkleX < 700) {
      ankleAlignment = true;
      setState(() {
    ...
    if (wristAlignment && ankleAlignment && kneeAndHipAlignment) {
      setState(() {
        ...
        memo = 'Plank position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Plank position not aligned.';
      });
    }
  }
