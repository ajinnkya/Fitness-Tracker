      ...
      children: <Widget>[
        Stack(
          children: [
            CustomPaint(
              painter:
                  MyPainter(left: leftShoulderPos, right: rightShoulderPos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: leftElbowPos, right: leftShoulderPos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: leftWristPos, right: leftElbowPos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: rightElbowPos, right: rightShoulderPos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: rightWristPos, right: rightElbowPos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: leftShoulderPos, right: leftHipPos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: leftHipPos, right: leftKneePos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: leftKneePos, right: leftAnklePos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: rightShoulderPos, right: rightHipPos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: rightHipPos, right: rightKneePos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: rightKneePos, right: rightAnklePos, color: correctColor),
            ),
            CustomPaint(
              painter: MyPainter(left: leftHipPos, right: rightHipPos, color: correctColor),
            ),
          ],
        ),
