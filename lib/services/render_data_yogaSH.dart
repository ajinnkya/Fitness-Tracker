...
class RenderDataYogaSH extends StatefulWidget {
  ...
  @override
  _RenderDataYogaSHState createState() => _RenderDataYogaSHState();
}

class _RenderDataYogaSHState extends State<RenderDataYogaSH> {
  Map<String, List<double>> inputArr;

  String excercise = 'Shirsasan';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Shirsasan position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (wristAlignment && ankleAlignment) {
      setState(() {
        ...
        memo = 'Shirsasan position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Shirsasan position not aligned.';
      });
    }
  }
