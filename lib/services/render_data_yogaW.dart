...
class RenderDataYogaW extends StatefulWidget {
  ...
  @override
  _RenderDataYogaWState createState() => _RenderDataYogaWState();
}

class _RenderDataYogaWState extends State<RenderDataYogaW> {
  Map<String, List<double>> inputArr;

  String excercise = 'Virbhadrasan';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Virbhadrasan position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (leftAnkleX > 250 && rightAnkleX < 200) {
      ankleAlignment = true;
      setState(() {
    ...
    if (wristAlignment && ankleAlignment && kneeAndHipAlignment) {
      setState(() {
        ...
        memo = 'Virbhadrasan position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Virbhadrasan position not aligned.';
      });
    }
  }
