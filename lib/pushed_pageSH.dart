...
import 'package:yoga_guru/services/render_data_yogaSH.dart';
...
class PushedPageSH extends StatefulWidget {
  final List<CameraDescription> cameras;
  final String title;
  const PushedPageSH({this.cameras, this.title});
  @override
  _PushedPageSHState createState() => _PushedPageSHState();
}

class _PushedPageSHState extends State<PushedPageSH> {
  List<dynamic> _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
  int x = 1;
