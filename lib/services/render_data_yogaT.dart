...
class RenderDataYogaT extends StatefulWidget {
  ...
  @override
  _RenderDataYogaTState createState() => _RenderDataYogaTState();
}

class _RenderDataYogaTState extends State<RenderDataYogaT> {
  Map<String, List<double>> inputArr;

  String excercise = 'Tadasan';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Tadasan position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (leftAnkleX <300 && leftAnkleX > 200 && rightAnkleX < 255   && rightAnkleX < 150) {
      ankleAlignment = true;
      setState(() {
    ...
    if (wristAlignment && ankleAlignment) {
      setState(() {
        ...
        memo = 'Tadasan position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Tadasan position not aligned.';
      });
    }
  }
