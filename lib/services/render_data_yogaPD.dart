...
class RenderDataYogaPD extends StatefulWidget {
  ...
  @override
  _RenderDataYogaPDState createState() => _RenderDataYogaPDState();
}

class _RenderDataYogaPDState extends State<RenderDataYogaPD> {
  Map<String, List<double>> inputArr;

  String excercise = 'Padhastasan';
  Color correctColor;
  Color armColor, shoulderColor, legColor;
  String memo = 'Padhastasan position not aligned.';
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (wristAlignment && ankleAlignment) {
      setState(() {
        ...
        memo = 'Padhastasan position aligned!';
      });
    } else {
      setState(() {
        correctColor = Colors.red;
        memo = 'Padhastasan position not aligned.';
      });
    }
  }
