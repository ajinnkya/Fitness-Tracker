...
class RenderDataLungeSquat extends StatefulWidget {
  ...
  RenderDataLungeSquat(
      {this.data, this.previewH, this.previewW, this.screenH, this.screenW});
  @override
  _RenderDataLungeSquatState createState() => _RenderDataLungeSquatState();
}

class _RenderDataLungeSquatState extends State<RenderDataLungeSquat> {
  Map<String, List<double>> inputArr;

  String excercise = 'lungesquat';
  ...
  bool _postureAccordingToExercise(Map<String, List<double>> poses) {
    setState(() {
      ...
      wristLY = poses['leftWristPos'][1];
      wristRY = poses['rightWristPos'][1];
    ...
    if (excercise == 'squat') {
      if (squatUp) {
        return poses['leftShoulder'][1] < 320 &&
            ...
            poses['leftWristPos'][1]>320 &&
            poses['rightWristPos'][1]>320&&
            (poses['rightKnee'][1] > 370 &&
            poses['leftKnee'][1] > 570)||
            (poses['rightKnee'][1] > 570 &&
                poses['leftKnee'][1] > 370);
      } else {
