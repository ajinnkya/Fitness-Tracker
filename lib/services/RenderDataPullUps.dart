...
class RenderDataPullUps extends StatefulWidget {
  ...
  @override
  _RenderDataPullUpsState createState() => _RenderDataPullUpsState();
}

class _RenderDataPullUpsState extends State<RenderDataPullUps> {
  Map<String, List<double>> inputArr;

  String excercise = 'Pull_Ups';
